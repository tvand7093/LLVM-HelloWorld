...
1. Download the [prebuilt Mac OS LLVM binaries](http://llvm.org/releases/3.8.0/clang+llvm-3.8.0-x86_64-apple-darwin.tar.xz) or the appropriate [Ubuntu binaries found here](http://llvm.org/releases/download.html#3.8.0).
